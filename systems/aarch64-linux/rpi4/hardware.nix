...
{ config, lib, pkgs, modulesPath, namespace, ... }:
with
lib.${namespace};
{
  imports =
  ...
  fileSystems."/mnt/wdhdd" = {
    ...
    fsType = "auto";
    # options = [ "noatime" "x-systemd.automount" "x-systemd.device-timeout=10" "x-systemd.idle-timeout=1min" "rw" "user" "nofail" "exec" "async" "auto" "dev" "suid" ];
